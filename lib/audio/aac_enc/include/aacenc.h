...
------------------------------------------------------------------------------*/
void AACEnc_AacInitDefaultConfig(Word16 id, AACENC_CONFIG *config);
...
Word16  AACEnc_AacEncOpen(Word16 id, AACENC_CONFIG *config);        /* pre-initialized config struct */
...
------------------------------------------------------------------------------*/
int AACEnc_SetWorkingBuf(Word16 id, int *buf);
