...
#define MAX_LDC_SLICE_NUM	(1)

#define MAX_LDC_OUT_BUF_NUM	(2)
...
typedef struct _MMP_LDC_MULTI_SLICE_INFO 
{
    ...
    MMP_UBYTE				ubScaleRatioH[MAX_LDC_SLICE_NUM];
    MMP_UBYTE				ubScaleRatioV[MAX_LDC_SLICE_NUM];
...
{	
    ...
    MMP_UBYTE				ubScaleRatioH;
    MMP_UBYTE				ubScaleRatioV;
    /* IBC Relative */
    MMP_ULONG				ulDstPosX;
    MMP_ULONG				ulDstPosY;
	/* LDC Relative */
