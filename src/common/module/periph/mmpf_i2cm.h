...
#define I2CM_WHILE_TIMEOUT      (0x1000000)
...
MMP_ERR MMPF_I2Cm_ReadEEDID(MMP_I2CM_ATTR *pI2cmAttr, MMP_UBYTE *ubData, MMP_USHORT usSeg, MMP_USHORT usOffset, MMP_USHORT usSize, MMP_DDC_OPERATION_TYPE mode);
