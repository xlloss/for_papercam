...
static void SNR_Cust_InitConfig(void)
{
    ...
    SensorCustFunc.OprTable->usSize[RES_IDX_1280x720_30FPS]     = (sizeof(SNR_OV9712_Reg_1280x720_Customer)/sizeof(SNR_OV9712_Reg_1280x720_Customer[0]))/2;
    SensorCustFunc.OprTable->uspTable[RES_IDX_1280x720_30FPS]   = &SNR_OV9712_Reg_1280x720_Customer[0];    
