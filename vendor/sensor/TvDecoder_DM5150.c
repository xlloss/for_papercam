...
static void SNR_DM5150_Cust_InitConfig(void)
{
	...
	pCust->OprTable->usSize[RES_IDX_720x240_30P]		    = (sizeof(SNR_DM5150_Reg_720x240_30P)/sizeof(SNR_DM5150_Reg_720x240_30P[0]))/2;
	pCust->OprTable->uspTable[RES_IDX_720x240_30P] 	        = &SNR_DM5150_Reg_720x240_30P[0];
