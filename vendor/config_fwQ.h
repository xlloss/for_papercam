...
#define  GPIO_MAP           QD_EVB_GPIO_MAP
...
@{ */
    ...
    #define SUPPORT_CG5162              (1)  //(1)
    #define SUPPORT_LM75A               (1)  //(1)
...
#if DRAM_SIZE <= 0x4000000 // only MDDR can use PLL_FOR_ULTRA_LOWPOWER_192
...
#if (PLL_CONFIG==PLL_FOR_ULTRA_LOWPOWER_192) || (PLL_CONFIG==PLL_FOR_ULTRA_LOWPOWER_168) 
#define PLL_FOR_ULTRA_LOWPOWER  (1)
#else
#define PLL_FOR_ULTRA_LOWPOWER  (0)
#endif
