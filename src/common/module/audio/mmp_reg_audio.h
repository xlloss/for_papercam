...
} __attribute__((__packed__)) AUD_FIFO;	
...
typedef struct _AITS_AUD {
	...
	} __attribute__((__packed__)) AFE_FIFO;
	AIT_REG_B   						_x5E[2];
    ...
    AIT_REG_B                           _x75[11];
     union {
    	AIT_REG_B  						_x80[30];						
		AUD_FIFO  MP;													// 0x80
	}__attribute__((__packed__)) ADC_FIFO;
    AIT_REG_B                           _x9E[74];
