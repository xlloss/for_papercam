...
#define __ait_define_initcall0(fn, id) \
	ait_initcall_t __ait_initcall_##fn##id = &fn
...
#define __ait_define_initcall6(fn, id)	\
    ait_initcall_t __ait_initcall_##fn##id = (ait_initcall_t)&fn 
...
#define ait_module_init(x)	        __attribute__((section("initcall"))) __ait_initcall(x)
