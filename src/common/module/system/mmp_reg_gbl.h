...
typedef struct _AITS_GBL {
    ...
    AIT_REG_B   GBL_DPPL0_PARAM[0x0B];                      // 0x5D05
        ...
        #define DPLL012_VCO_TYPE2           (DPLL0_ICP_15uA | DPLL0_KVCO_OFFSET_5uA | DPLL0_VCO_CTL_1d5G)
         // for 552/528MHz usage 
        #define DPLL012_VCO_TYPE3           (DPLL0_ICP_15uA | DPLL0_VCO_CTL_1d5G)
        #define DPLL012_VCO_TYPE4           (DPLL0_ICP_20uA | DPLL0_KVCO_OFFSET_5uA)
