...
@{ */
    ...
    #define VIDRECD_RESOL_MAX_NUM      	(22)
    ...
    #define VIDRECD_RESOL_1472x736_LDC  (15)
    #define VIDRECD_RESOL_1440x1088     (16)
	#define VIDRECD_RESOL_1920x1088    	(17)
	#define VIDRECD_RESOL_2304x1296     (18)
    #define VIDRECD_RESOL_2560x1440     (19)
    #define VIDRECD_RESOL_2704x1536		(20)
	#define VIDRECD_RESOL_3840x2160		(21)
