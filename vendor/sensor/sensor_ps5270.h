...
#ifndef	_SENSOR_PS5270_H_
#define	_SENSOR_PS5270_H_
...
#ifndef SENSOR_IF
//ps5270 support 1 and 2 lens. 
//Due to SNR not good, we suggest using 2 lens definition.
//for high speed use SENSOR_IF_MIPI_2_LANE
#define SENSOR_IF 		(SENSOR_IF_MIPI_2_LANE) //SENSOR_IF_PARALLEL //(SENSOR_IF_MIPI_2_LANE)
#endif


//#define USE_10_BIT 				(0)

#define RES_IDX_1920x1080_30P 	(0) 	// mode 1, 1920 * 1080 30P, Video  (16:9)
#define RES_IDX_1280x720_30P    (1) 	// mode 1, 1920 * 1080 30P, Video  (16:9)

//#define RES_IDX_1920x1080_25P 	(1) 	// mode 0, 1920 * 1080 25P, Video  (16:9)
...
#define SENSOR_DRIVER_MODE_4TO3_14M_30P_RESOLUTION 	(SENSOR_DRIVER_MODE_NOT_SUUPORT) 	// 4352*3264 30P
    ...
    // For Camera Preview
    #if 1//(LCD_MODEL_RATIO_X == 16) && (LCD_MODEL_RATIO_Y == 9)
