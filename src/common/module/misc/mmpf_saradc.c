...
//  Description : 
//------------------------------------------------------------------------------
MMP_ERR MMPF_SARADC_Init(MMPF_SARADC_ATTR *saradc_attribute)
{   
...
//------------------------------------------------------------------------------
//  Function    : MMPF_SARADC_PowerDown
//  Description : 
//------------------------------------------------------------------------------
MMP_ERR MMPF_SARADC_PowerDown(void)
{
    AITPS_SARADC_POR pSARADC   =   AITC_BASE_SARADC_POR;   
    MMP_UBYTE   temp;
    MMPF_SARADC_ATTR saradc_attribute;
...
//------------------------------------------------------------------------------
//  Function    : MMPF_SARADC_WriteByte
//  Description : 
//------------------------------------------------------------------------------
...
MMP_ERR MMPF_SARADC_SetChannel(MMP_SHORT channel)
{
    ...
    RTNA_DBG_Str3("AUX");
    RTNA_DBG_Short3(channel);
    RTNA_DBG_Str3(" select\r\n"); 
    return MMP_ERR_NONE;
}
