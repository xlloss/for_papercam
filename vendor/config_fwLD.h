...
@{ */
  ...
  #define SUPPORT_UVC_ISP_EZMODE_FUNC   (1) // EZ IQ-tuning tool
...
@{ */
    ...
    #define SUPPORT_OPT3006             (1) // same as 3001
    #define SUPPORT_PAS7671             (0)
    
    #if SUPPORT_OPT3006==1
    #define ISP_WAIT_LUX_EN              (0)
    #endif
...
@{ */
    ...
    #define SUPPORT_PWM                 (0)
    #define SUPPORT_ADC                 (0)
    #define SUPPORT_IRLED               (1)
...
#elif ((BIND_SENSOR_PS5220==1)||(BIND_SENSOR_PS5250==1)||(BIND_SENSOR_PS5270==1) ) // for low power test
  // for LD project, always go into 528MHz
  #if 0//( DRAM_SIZE <= 0x4000000 ) && (SUPPORT_AEC==0) // only MDDR can use PLL_FOR_ULTRA_LOWPOWER_192
    #define PLL_CONFIG  PLL_FOR_ULTRA_LOWPOWER_192 
  #else
    #define PLL_CONFIG  PLL_FOR_POWER
  #endif
  #define PLL_FOR_ULTRA_LOWPOWER  (1)
#else
  #define PLL_CONFIG  PLL_FOR_POWER 
#endif
