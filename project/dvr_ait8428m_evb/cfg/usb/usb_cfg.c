...
USB_UVC_DEV_INFO        gUsbh_UvcDevInfo;
/*
 *      PID     VID     VC  VS  EU  IT  PU  Typ Ep
 * 5256 0C45    64AB    0   1   3   1   2   1   81
 * 216  0C45    6300    0   1   4   1   3   1   81
 * 8451 114D    8451    0   1   6   1   3   2   81
 * 8437 114D    8455    0   1   6   1   3   2   81
 */

/* UVC(rear cam) Mjpeg WiFi Stream info. */
USB_UVC_MJPEG_WIFI_CFG  gUsbh_UvcMjpegWifiCfg;
